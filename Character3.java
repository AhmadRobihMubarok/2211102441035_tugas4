...
public class Character3 extends Actor {
    private GreenfootImage character3Image;
    private int speed = 5; // Kecepatan karakter
    private int lives = 3; // Jumlah nyawa karakter

    public Character3() {
        character3Image = new GreenfootImage("character3.png");
        setImage(character3Image);
    }
    ...
    public void checkForCollision() {
        Actor object = getOneIntersectingObject(stawberry.class);
        if (object != null) {
            increaseScore();

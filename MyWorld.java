...
public class MyWorld extends World {
    ...
    public void act() {
        if (getObjects(stawberry.class).isEmpty()) {
            if (currentLevel < 3) {
                currentLevel++;
    ...
    public void prepare() {
        addObject(new Character3(), getRandomX(), getRandomY());
        addObject(new stawberry(), getRandomX(), getRandomYAvoidEnemies());
        addObject(new Enemy(), getRandomX(), getRandomYAvoidEnemies());
    }

    public void nextLevel() {
        removeObjects(getObjects(stawberry.class));
